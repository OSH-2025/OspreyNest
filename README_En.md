...
|May 30|Offline Group Discussion|Group Discussion|Connect LED lights to the Raspberry Pi and attempt to connect all modules in series to test whether the LED lights can be voice-controlled.|
