...
|5.30|线下集体研讨|集体研讨|将LED灯连接至树莓派，尝试串联起来所有模块测试LED灯是否可受语音控制|将LED灯连接至树莓派，发现树莓派电压不稳，未能实现语音控制，决定会后找各模块的bug后再集体研讨|
|6.3|线下集体研讨|集体研讨当前问题|发现需要使用wasm解析指令后发送至树莓派，还需要树莓派段部署wasm|已在树莓派端部署wasm，保证树莓派可以接收wasm的指令|
