...
|5.30|线下集体研讨|将LED灯连接至树莓派，尝试串联起来所有模块测试LED灯是否可受语音控制|将LED灯连接至树莓派，发现树莓派电压不稳，未能实现语音控制,但已经实现本地浏览器端和树莓派端的连接，树莓派可以接受网页的内容|
|6.3|线下集体研讨|集体研讨当前问题|发现需要使用wasm解析指令后发送至树莓派，还需要树莓派段部署wasm运行环境；明确、细化下一步分工，任务包括在本地和树莓派端安装wasm运行环境，本地部署docker环境，|
