...
|6.22|线下集体讨论|总结方案可行性，作出下一步项目安排|针对网页端访问限制的方案进行汇总讨论，挑选出最优方案推进：即使用一台电脑作为服务器，其他设备通过其IP及相应端口进行控制；针对该方案进行细化，完成相关任务|
|6.23|线下集体讨论|总结当前进度，集中准备期末答辩|初步确定答辩内容及形式，针对期中汇报的PPT制作和总体效果进行评估，提出改进建议|
